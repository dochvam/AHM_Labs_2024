...
In this lab, we'll explore one case where you might want to use real-world 
...
I'll simulte datasets of different sizes, fit the linear model, and track the rate at which we detect the true relationship that $\beta_1 \neq 0$.
...
```{r}
simulate_data <- function(nsites_per_forest, nreps,
                          true_forest_effect, 
                          true_forest_sd,
